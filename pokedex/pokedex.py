...
class Pokedex:
    def __init__(self, data_file):
        ...
        pygame.init()
        self.ecran = pygame.display.set_mode((400, 600))
    ...
    def afficher_image_fond(self):
        image_fond = pygame.image.load("fond.png").convert()
        image_fond = pygame.transform.scale(image_fond, (400, 600))
